...
**Demo**: measured directly (`monopoly batch`, 3000 games, Buy Good/Buy All/Buy Bad, `max_turns: 300`, base seed 1) — the exact stalemate [player-strategies.md#trading](./player-strategies.md#trading)'s cited research predicts, and its fix: with `trading_enabled: false`, only 23.9% of games produce any winner within 300 turns; with it `true`, 62.4% do — and Buy Good's and Buy All's own win rates roughly triple and double respectively (11.2% → 32.6%, 12.7% → 29.8%) purely because far more games actually resolve. Evidence the addition changed outcomes, not just added surface area.
